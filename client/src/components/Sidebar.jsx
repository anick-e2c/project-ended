...
import assets, { userDummyData } from '../assets/assets1'
    ...
    <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUSer ? "max-md:hidden" : ''}`}>
        <div className='pb-5'> 
            <div className='flex justify-between items-center'>
                ...
                <img src={ assets.menu_icon } alt="menu" className='max-h-5 cursor-pointer' /> 
                   <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-md 
                    ...
                    '>
                        <p onClick={() => navigage('/profile>')} className='cursor-pointer text-sm'>Edit Profile</p>
            ...
            <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5'>
                ...
                <input type="text" className="bg-transparent border-none outline-none  text-white texte-xs
                placeholder-[#c8c8c8] flex-1" placeholder='Search User...' id="" />
            </div>
        </div>
        {/* -----User List----- */}
