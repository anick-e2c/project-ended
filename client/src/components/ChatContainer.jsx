...
import assets, { messagesDummyData } from '../assets/assets1'
...
const ChatContainer = ({selectedUser, setSelectedUser}) => {
  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg bg-[#282142] text-white flex flex-col'>
      {/*---------header-------*/}
    ...
    <div className='flex flex-col items-center justify-center gap-2 text-gray-500 bg-white/10 max-md:hidden'>
      ...
      <p className='text-lg font-medium text-white'>
        Chat anytime, anywhere with QuickChat!
      </p>
    </div>
  )
}
